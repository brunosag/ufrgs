...
\course{Fundamentos de Banco de Dados \textendash INF01145}
\title{
    Trabalho Prático \textendash Etapa 2 \\[8pt]
    \Large Comandos de Definição de Dados (DDL)
}
\authors{
    Bruno Samuel Ardenghi Gonçalves \textemdash 550452 \\[2pt]
    Leonardo Azzi Martins \textemdash 323721
}
